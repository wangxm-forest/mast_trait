...
\item All these studies use CV to quantify masting but we use a binary definition, whether this species is a strong masting species or weak masting species on a broader species-level
...
\item The lit on this mostly talk about adaptive significance, we need to understand its broader macroevolutionary patterns
