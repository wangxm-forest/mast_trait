...
\item Angiosperm 79\% (98/124) with masting data; Masting and non-masting split almost equally 52\% (51/98); Gymnosperm 95\% (61/64) with masting data; almost all species are masting 89\% (54/61)
\end{enumerate}
...
% Tue Jun 23 21:25:55 2026
\begin{tabular}{lllrrrrrr}
  \hline
Trait & Type & Predictor & N & Estimate & SE & P & Phylo $\alpha$ & Half-time \\ 
  \hline
Seed weight (log) & Numeric & Seed weight (log) &  89 & 0.22 & 0.09 & 0.01 & 11.32 & 0.06 \\ 
  Fruit size (log) & Numeric & Fruit size (log) &  83 & 0.00 & 0.31 & 0.99 & 28.28 & 0.02 \\ 
  Oil content (\%) & Numeric & Oil content (\%) &  19 & 0.03 & 0.03 & 0.21 & 18.85 & 0.04 \\ 
...
Trait & Type & Predictor & N & Estimate & SE & P & Phylo $\alpha$ & Half-time \\ 
  \hline
Seed weight (log) & Numeric & Seed weight (log) &  58 & -0.01 & 0.24 & 0.96 & 53.48 & 0.01 \\ 
  ...
  Leaf longevity (years) & Numeric & Leaf longevity (years) &  37 & 0.15 & 0.34 & 0.66 & 54.36 & 0.01 \\ 
   \hline
\end{tabular}}
