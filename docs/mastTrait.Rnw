...
\begin{table}[h]
    \caption{Phyloglm results for conifer species, SE: standard error; P: p-value; N: number of effective sample size}
    \includegraphics[width=1\textwidth]{../output/phyloglmConifer.pdf}
    \label{tab:phyloconifer}
\end{table}

\begin{table}[h]
    \caption{Phyloglm results for angiosperm species, SE: standard error; P: p-value; N: number of effective sample size}
    \includegraphics[width=1\textwidth]{../output/phyloglmAngio.pdf}
    \label{tab:phyloangiotable}
\end{table}
...
\begin{table}[h]
    \caption{PGLS results for conifer species, SE: standard error; P: p-value; N: number of effective sample size}
    \includegraphics[width=1\textwidth]{../output/pglsConifer.pdf}
    \label{tab:pglsconifertable}
\end{table}

\begin{table}[h]
    \caption{PGLS results for angiosperm species, SE: standard error; P: p-value; N: number of effective sample size}
    \includegraphics[width=1\textwidth]{../output/pglsAngio.pdf}
    \label{tab:pglsangiotable}
\end{table}
\newpage
% ------------------------------------------
Just to be consistant with the binary trait response variable, I also ran lm using conifer and angiosperm as a fixed effect in the model. Nothing is significant except for conifer vs angiosperm:
\begin{table}[h]
    \caption{lm results, SE: standard error; P: p-value; N: number of effective sample size}
    \includegraphics[width=1\textwidth]{../output/lmResults.pdf}
    \label{tab:lmtable}
\end{table}
