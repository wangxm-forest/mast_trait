...
\end{enumerate}
\subsection{Different hypotheses operating at different reproductive stages like filters}
\begin{enumerate}
...
\end{enumerate}
\subsection{Why traits can help link hypotheses to masting mechanisms}
\begin{enumerate}
\item Mechanisms might not be mutually exclusive, but some might be stronger than the other for certain species
...
\end{enumerate}
\item Existing studies mainly trying to find relations between different traits and masting.
...
\item Especially when consider whether the evolutionary drivers are more similar for clades those are closely related.
\end{enumerate}
\subsection{Use data from one specific geographical region}
\begin{enumerate}
...
\item These act at the start and the end of the reproductive cycle, provide evolutionary incentive, which I will explain below
...
%Maybe I can try to subset wind dispersed and animal dispersed species and see if this relationship between seed weight and masting is stronger for animal dispersed species!
\end{enumerate}
