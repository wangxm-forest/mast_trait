...
\begin{enumerate}
\item Traits may matter to masting below the species level given that we did not find any strong evidence at species level
\item Examples of species that mast only under certain environmental conditions (E.g., \textit{Hymenaea coubaril})
\item Traits need to be measured locally and match with masting data
\end{enumerate}
