...
%emw25May2026 -- please switch to \enumerate
...
%emw25May2026 -- do you want to start a new break here? It seems like 'Mechanisms are not mutually exclusive' is likely a separate paragraph and you may want to give some examples of this? Or explain more somehow. 
...
\begin{itemize}
%emw25May2026 --  how did you pick the order below? If you're not sure what works, then mirror an order you have above. 
...
\end{itemize}
\item Existing studies seem focus mainly on correlations %emw25May2026 -- so do we ... can you explain more what you want to say here? 
...
\item If the pattern is strong enough, we might be able to find it even using a binary masting definition %emw25May2026 -- I think this may belong in the discussion?
%emw25May2026 -- this should be a separate section from the above
...
\item These act at the start and the end of the reproductive cycle, provide evolutionary incentive %emw25May2026 --  nice! (What is an evolutionary incentive though?)
%emw25May2026 -- I think you need a new break here .. 
\item Discuss mechanisms in the context of existing literature
\begin{itemize}
\item Previous literature on seed mass and masting think from the resource depletion perspective %emw25May2026 --  can you explain more?
...
\begin{enumerate}
\item No evidence found at species level data does not mean traits are not related to masting %emw25May2026 -- I would rephrase this .. . I always dislike when authors say 'but it doesn't mean my hypothesis is not true!' ... it would be better to say: traits may matter to masting BELOW the species level 
...
\end{enumerate}
\subsection{Evolutionary scale} %emw25May2026 -- at some point we may want to make the point that basically we think these relationships may appear at different scales -- either below the population level or while controlling for deep evolutionary time... 
\begin{enumerate}
\item Angiosperm vs. gymnosperm results
\begin{itemize}
%emw25May2026 -- can you connect for me what the below means? What point do you want to make here? 
...
\end{itemize}
\end{itemize}
%emw25May2026 -- I think the below two points are their own subsection and you should refer back to the literature here (you could start adding citations to the outline)
...
%emw25May2026 -- I see the below as a full section on future pathways or at least a paragraph ... do you have more to say here?
